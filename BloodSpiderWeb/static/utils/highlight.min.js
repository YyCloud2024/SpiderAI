        ...
        var ne = (n => {
            ...
            function y(e) {
                ...
                if (x("before:highlightElement", {
                    el: e, language: t
                }), e.children.length > 0 && (d.ignoreUnescapedHTML || (console.error("其中一个代码块包含未转义的HTML。这是一个潜在的严重安全风险。"),
                    console.error("这是解释这个警告的网页,你可以进来看看: https://github.com/highlightjs/highlight.js/wiki/security"),
                    console.error("具有未转义HTML的元素是："),
                    console.error(e)), d.throwUnescapedHTML)) throw new V("其中一个代码块包含未转义的HTML。", e.innerHTML)
                    ;
                n = e;
